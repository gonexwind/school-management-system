            ...
            <ul class="u-sidebar-nav-menu u-sidebar-nav-menu--top-level">
                ...
                <li class="u-sidebar-nav-menu__item">
                    ...
                    <ul id="setup-management" class="u-sidebar-nav-menu u-sidebar-nav-menu--second-level"
                        ...
                        <li class="u-sidebar-nav-menu__item">
                            <a class="u-sidebar-nav-menu__link" href="{{ route('student-year.index') }}">
                                <span class="u-sidebar-nav-menu__item-title">Student Year</span>
                            </a>
                        </li>
                        <li class="u-sidebar-nav-menu__item">
                            <a class="u-sidebar-nav-menu__link" href="{{ route('student-group.index') }}">
                        ...
                        <li class="u-sidebar-nav-menu__item">
                            <a class="u-sidebar-nav-menu__link" href="{{ route('fee-category.index') }}">
                        ...
                        <li class="u-sidebar-nav-menu__item">
                            <a class="u-sidebar-nav-menu__link" href="{{ route('exam-type.index') }}">
                                <span class="u-sidebar-nav-menu__item-title">Exam Type</span>
                            </a>
                        </li>
                        <li class="u-sidebar-nav-menu__item">
                            <a class="u-sidebar-nav-menu__link" href="{{ route('school-subject.index') }}">
                                <span class="u-sidebar-nav-menu__item-title">School Subject</span>
                            </a>
                        </li>
                        <li class="u-sidebar-nav-menu__item">
                            <a class="u-sidebar-nav-menu__link" href="{{ route('assign-subject.index') }}">
