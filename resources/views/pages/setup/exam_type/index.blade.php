            ...
            <section class="breadcumb-area card bg-gradient mb-5">
                <div class="bread-cumb-content card-body d-flex align-items-center">
                    <div class="breadcumb-heading">
                        <h2 class="text-white">Exam Type List</h2>
                    </div>
            ...
            <section class="es-form-area">
                <div class="card">
                    <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                        <a href="{{ route('exam-type.create') }}" class="btn btn-sm btn-pill btn-outline-light ml-auto">+
                            Add New</a>
                    </header>
                    <div class="card-body">
                                    ...
                                    @foreach($exams as $key => $data)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('exam-type.destroy', $data->id) }}"
                                                      method="post">
                                                    @csrf
                                                    @method('DELETE')

                                                    <a href="{{ route('exam-type.edit', $data->id) }}"
